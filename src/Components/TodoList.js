                    ...
                    (todo, index) =>
                        !todo.deleted && (
                            <Card
                                ...
                                createDate={todo.createDate ? todo.createDate : "Initial"}
                                createTime={todo.createTime ? todo.createTime : "Initial"}
                                editTodoDate={todo.editTodoDate ? todo.editTodoDate : false}
                                editTodoTime={todo.editTodoTime ? todo.editTodoTime : false}
                            />
                        )
                )}
            </TodoListWrapper>
